...
return [
    ...
    'routes' => [
        ...
        // gui - get
        ['method' => 'get', 'url' => '/people', 'callback' => [\people\controllers\MainController::class, 'index'], 'name' => 'people'],
        ['method' => 'get', 'url' => '/people/create', 'callback' => [\people\controllers\MainController::class, 'createForm'], 'name' => 'people-create'],
        ['method' => 'get', 'url' => '/people/update/(\d+)', 'callback' => [\people\controllers\MainController::class, 'updateForm'], 'name' => 'people-update'],
        ['method' => 'get', 'url' => '/people/delete/(\d+)', 'callback' => [\people\controllers\MainController::class, 'deleteForm'], 'name' => 'people-delete'],
