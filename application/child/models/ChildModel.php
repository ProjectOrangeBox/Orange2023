...
namespace application\child\models;
...
class ChildModel extends Model
{
    ...
    protected array $rules = [
        ...
        'age' => ['isRequired|isInteger|isGreaterThan[0]|isLessThan[111]', 'Age'],
        'join_id' => ['isRequired|isInteger', 'Join ID'],
    ];
    protected array $ruleSets = [
        'create' => ['firstname', 'lastname', 'age', 'join_id'],
        'update' => ['id', 'firstname', 'lastname', 'age', 'join_id'],
        'delete' => ['id'],
        'read'   => ['id'],
    ];
