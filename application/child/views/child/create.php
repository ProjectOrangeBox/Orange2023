...
<div class="masthead container">
    <form id="form">
        ...
        <div class="mb-3 float-end">
            ...
            <a rv-on-click="actions.submit" data-url="<?= getUrl($view . '_post') ?>" data-type="post" data-form="form" data-redirect="<?= getUrl($view . '_get_read_list') ?>" class="btn btn-primary">Submit</a>
        </div>
    </form>
</div>
<?php fig::end() ?>
