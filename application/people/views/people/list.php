    ...
    <table id="table" class="table table-striped">
        ...
        <tbody>
            <tr rv-each-row="records">
                ...
                <td>{row.colorname}</td>
                <td>
                    <button type="button" rv-on-click="actions.redirect" data-redirect="<?= getUrl('peopleReadForm', ['#'], true) ?>" rv-data-id="row.id" class="btn btn-primary"><i class="fa-solid fa-eye"></i></button>
                    <button type="button" rv-on-click="actions.loadModal" data-modal="<?= getUrl('peopleUpdateForm', ['#'], true) ?>" rv-data-id="row.id" data-size="modal-xl" class="btn btn-primary"><i class="fa-solid fa-square-pen"></i></button>
                    <button type="button" rv-on-click="actions.loadModal" data-modal="<?= getUrl('peopleDeleteForm', ['#'], true) ?>" rv-data-id="row.id" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></button>
                </td>
            </tr>
        </tbody>
    </table>
