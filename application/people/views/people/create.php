<div rv-add-show-class="show.create" class="masthead container">
    ...
    <div class="mb-3">
        <div class="form-group">
            ...
            <select rv-refresh="refresh.colordropdown" name="color" rv-class-is-invalid="validation.color" class="form-control" rv-value="createRecord.color | default 4" model="<?= getUrl('peopleColorDropdown') ?>" property="colorDropDown">
    ...
    <div class="mb-3 float-end">
        ...
        <a rv-on-click="actions.go" method="post" url="<?= getUrl('peopleCreate') ?>" property="createRecord" on-success-hide="show.create" on-success-show="show.grid" on-success-refresh="refresh.grid" on-failure="actions.showValidationErrors" class="btn btn-primary">Submit</a>
    </div>
</div>