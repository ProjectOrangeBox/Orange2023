<div>
    ...
    <div class="mb-3 float-end">
        ...
        <a rv-on-click="actions.go" method="put" rv-url="'<?= getUrl('peopleUpdate', ['{1}'], true) ?>' | replace updateRecord.id" property="updateRecord" on-success-hide="show.update" on-success-refresh="refresh.grid" on-success-action="actions.clearValidation" on-failure-property="@root" class="btn btn-primary">Submit</a>
    </div>
</div>