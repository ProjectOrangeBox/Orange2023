...
<?php fig::block('body') ?>
<div class="masthead container" data-autoload="true" data-model="<?=getUrl('people_one',[$id]) ?>" data-property="record">
  <form id="form">
    <div class="mb-3">
    ...
    <div class="mb-3 float-end">
      <a rv-on-click="methods.cancel" data-redirect="<?=getUrl('people') ?>" class="btn btn-primary">Done</a>
    </div>
  </form>
</div>
<?php fig::end() ?>
