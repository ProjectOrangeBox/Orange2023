...
class Application
{
    ...
    public static function bootstrap(array $config): ContainerInterface
    {
        ...
        $config = array_replace_recursive(include __DIR__ . '/config/config.php', $config);
        ...
        require_once $config['error class'];
        ...
        return self::setupContainer($config);
    }

    public static function setupContainer(array $config): ContainerInterface
    {
