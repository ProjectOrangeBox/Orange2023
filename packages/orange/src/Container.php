...
class Container extends Singleton implements ContainerInterface
{
    ...
    {
        // standardized name
        $serviceName = $this->normalizeName($serviceName);
    ...
    {
        return isset($this->registeredServices[$this->normalizeName($serviceName)]);
    }
    ...
    {
        unset($this->registeredServices[$this->normalizeName($serviceName)]);
    }
    ...
    {
        $this->registeredServices[$this->normalizeName($serviceName)] = [
            self::TYPE => $type,
    ...
    {
        return $this->attach(self::ALIAS, $alias, $this->normalizeName($serviceName));
    }
