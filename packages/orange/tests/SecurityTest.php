...
final class SecurityTest extends unitTestHelper
{
    ...
    private $publicKeyFile = __DIR__ . '/support/writeable/public.key';
    private $privateKeyFile = __DIR__ . '/support/writeable/private.key';

    protected function setUp(): void
    {
        Security::createKeys($this->publicKeyFile, $this->privateKeyFile, 2048);

        $this->instance = Security::getInstance([
            'ssl public key' => $this->publicKeyFile,
            'ssl private key' => $this->privateKeyFile,
        ]);
    }
