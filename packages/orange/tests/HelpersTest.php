...
final class HelpersTest extends unitTestHelper
{
    ...
    {
        require_once __DIR__ . '/../src/helpers/Ary.php';
        require_once __DIR__ . '/../src/helpers/Dot.php';
    ...
    public function testMergeDefaultConfig(): void
    {
        ...
        $this->assertEquals($match, $this->mergeDefaultConfig($config, WORKINGFOLDER . '/configExample2.php'));
    }

    public function testLogMsg(): void
    {
        $this->testFile = WORKINGFOLDER . '/writeable/test-log.txt';
        ...
        // test away!
        log::msg(LOG::ALERT, 'This is an Alert!');
    ...
    {
        $testFile = WORKINGFOLDER . '/writeable/test.txt';
    ...
    {
        // setup config
        $config = Config::getInstance(['config folder' => WORKINGFOLDER . '/env']);
