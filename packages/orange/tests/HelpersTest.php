...
final class HelpersTest extends unitTestHelper
{
    ...
    public function testMergeDefaultConfig(): void
    {
        ...
        $this->assertEquals($match, Application::mergeDefaultConfig($config, __DIR__ . '/support/configExample2.php'));
    }
    ...
    {
        // setup config
        $config = Config::getInstance(['config folder' => __DIR__ . '/support/env']);
