...
{
    private static ?MergeView $instance = null;
    ...
    {
        return $this->merge->parse(file_get_contents($view), array_replace((array)$this->data, $data), [$this, 'pluginCallBackHandler']);
    }

    public function renderString(string $string, array $data = []): string
    {
        return $this->merge->parse($string, array_replace((array)$this->data, $data), [$this, 'pluginCallBackHandler']);
    }
