...
class Remap extends Singleton implements RemapInterface
{
     ...
     */
    public function request(string $method, string $mapping): array
    {
    ...
    {
        Log::msg('debug', __METHOD__ . ' formula ' . $expression);
    ...
    {
        Log::msg('debug', __METHOD__ . ' input ' . $input);
        ...
        Log::msg('debug', __METHOD__ . ' output ' . $input);
