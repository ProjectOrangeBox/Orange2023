...
final class discTest extends TestCase
{
    ...
    {
        $this->assertTrue(disc::autoGenMissingDirectory('/working/x/y/z/newtestfolder.txt'));

        $this->assertTrue(disc::exists('/working/x/y/z'));
        $this->assertFalse(disc::exists('/working/x/y/z/newtestfolder.txt'));

        $this->assertTrue(disc::autoGenMissingDirectory('/working/x/a/b/newtestfolder.txt'));
    ...
    public function testRenameDirectory(): void
    {
        ...
        $this->assertTrue((new Directory('/working/files/testfolder'))->exists());
        $this->assertTrue((new File('/working/files/testfolder/test_file.txt'))->exists());
    }
    ...
    public function testMove(): void
    {
        ...
        disc::move(new Directory('/working/files/testfolder'), new Directory('/working/files/foobar'));
